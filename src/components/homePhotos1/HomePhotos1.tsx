    ...
    return (
        <>
            ...
            <div className="homePhotos1Cont flex wrap">
                <CardImg1 imgSrc="/images/design/1.jpeg" text="Ampliar Imagen" />
                <CardImg1 imgSrc="/images/design/2.jpeg" text="Ampliar Imagen" />
                <CardImg1 imgSrc="/images/design/3.jpeg" text="Ampliar Imagen" />
                <CardImg1 imgSrc="/images/design/4.jpeg" text="Ampliar Imagen" />
                <CardImg1 imgSrc="/images/design/5.jpeg" text="Ampliar Imagen" />
                <CardImg1 imgSrc="/images/design/6.jpeg" text="Ampliar Imagen" />
                <CardImg1 imgSrc="/images/design/7.jpeg" text="Ampliar Imagen" />
                <CardImg1 imgSrc="/images/design/8.jpeg" text="Ampliar Imagen" />
            </div>
        </>
    )
}
