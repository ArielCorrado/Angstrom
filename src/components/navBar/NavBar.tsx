...
const NavBar = () => {
    ...
    useEffect(() => {   
        ...
        const navBarNamesRef = [
            ["/home", "home"], ["/team", "equipo"], ["/contact", "contacto"], ["/about", "nosotros"]  //Posicion 0: texto que tiene que tener la ruta, posicion 1: texto que tiene que tener la opcion del navbar
        ]    
