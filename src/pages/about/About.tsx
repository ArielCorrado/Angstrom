    ...
    return (
        <div className="seccions seccionToWaitImages seccionsWithPadding flex">
            ...
            <div className="aboutTextCont cvTextCont cvText fadeInDer flex column">
                ...
                <div className="aboutTextDiv flex"><span className="bullet">●</span><p>Planos de hormigón para constructoras</p></div>
                <div className="aboutTextDiv flex"><span className="bullet">●</span><p>Planos de fabricación e instalación de muebles de oficinas</p></div>
                <div className="aboutTextDiv flex"><span className="bullet">●</span><p>Desarrollo de planos de fabricación de piezas para un proyecto de avion ultraliviano fabricado en Argentina</p></div>
                <div className="aboutTextDiv flex"><span className="bullet">●</span><p>Consultoría y desarrollo de proyectos de piedra avanzados (marmol y granito)</p></div>
